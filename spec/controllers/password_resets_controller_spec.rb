...
RSpec.describe PasswordResetsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all password_resets as @password_resets" do
      ...
      expect(assigns(:password_resets)).to eq([password_reset])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new password_reset as @password_reset" do
      ...
      expect(assigns(:password_reset)).to be_a_new(PasswordReset)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created password_reset as @password_reset" do
        post :create, {:password_reset => valid_attributes}, valid_session
        expect(assigns(:password_reset)).to be_a(PasswordReset)
        expect(assigns(:password_reset)).to be_persisted
      end

      it "redirects to the created password_reset" do
        post :create, {:password_reset => valid_attributes}, valid_session
        expect(response).to redirect_to(PasswordReset.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved password_reset as @password_reset" do
        post :create, {:password_reset => invalid_attributes}, valid_session
        expect(assigns(:password_reset)).to be_a_new(PasswordReset)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested password_reset" do
        password_reset = PasswordReset.create! valid_attributes
        put :update, {:id => password_reset.to_param, :password_reset => new_attributes}, valid_session
      ...
      it "redirects to the password_reset" do
        password_reset = PasswordReset.create! valid_attributes
        put :update, {:id => password_reset.to_param, :password_reset => valid_attributes}, valid_session
        expect(response).to redirect_to(password_reset)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the password_reset as @password_reset" do
        password_reset = PasswordReset.create! valid_attributes
        put :update, {:id => password_reset.to_param, :password_reset => invalid_attributes}, valid_session
        expect(assigns(:password_reset)).to eq(password_reset)
      end
